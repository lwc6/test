...
public class TeacherInfoDeal {
	...
	@RequestMapping("/deleteTeaches")
	@ResponseBody
	public String deleteTeaches(@RequestParam("nums") Object nums) {
		...
		if (teacherService.deleteByForeachT(data) > 0) {
			return "success";
		} else {
			return "fail";
		}
	...
	public String deleteStu(@RequestParam("num") String num) {
		if (teacherService.deleteTeacher(num) > 0) {
			return "success";
		} else {
			return "fail";
		}
